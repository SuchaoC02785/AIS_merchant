...
Edit merchant profile ui of thai-juristic
    ...
    ubold@coderthemes.com   test    chao                    ${EMPTY}           ${EMPTY}            ${EMPTY}          ${EMPTY}                         ${EMPTY}                             ${EMPTY}                        ${EMPTY}         ${EMPTY}        ${EMPTY}                 ${EMPTY}               ${EMPTY}        tax4     bow shopnew        คุณ       โบวี่              นางสาวสุนิตา ลีติกุล  การบำบัดน้ำเสีย         ธุรกิจเกี่ยวกับสิ่งแวดล้อมและการบำบัดน้ำเสีย    อสังหาริมทรัพย์          107.0        100.0           vitgointer@test.com     www.vitgointer.com      105549050730    tax1
...
#     Should Be Equal As Strings  ${gettext}  ไทย-นิติบุคคล
