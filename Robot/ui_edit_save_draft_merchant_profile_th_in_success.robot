...
*** Test Case ***
Edit merchant profile ui of thai-individual
...
Edit merchant profile ui of thai-individual information
    ...
    When I must see merchant list after save draft
...
I fill new data merchant information
    ...
    Should Be Equal As Strings  ${getbustype}  ไทย-บุคคลธรรมดา
...
I check data after edit
    ...
    Should Be Equal As Strings  ${getbustypeN}  ไทย-บุคคลธรรมดา
